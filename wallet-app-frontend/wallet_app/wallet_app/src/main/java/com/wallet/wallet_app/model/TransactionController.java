...
public class TransactionController {
    ...
    public ResponseEntity<List<Transaction>>viewAllTransactionByTypeHandler(@PathParam ("transactiontype"TransactionType type,@PathVariable String uniqueId)   throws CustomerNotException,UserNotLoggedInException,TransactionNotFoundException,@PathVariable String unique_id)throws CustomerNotException,UserNotLogedInException,TransactionNotFoundException{
        List<Transaction>TransactionType=transactionService.viewAllTransactionByTransactionType(unique_id,type);
